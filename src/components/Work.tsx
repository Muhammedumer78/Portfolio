...
//img
import Img1 from "./../../public/price.jpg";
import Img2 from "./../../public/portfolio-img2.png";
import Img3 from "./../../public/logo23.webp";
import Img4 from "./../../public/meta.png";

const Work = () => {
  return (
    <section className="section" id="work">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-x-10 mt-40 ">
          <div className="flex-1 flex flex-col gap-y-12 mb-10 mt-96 lg:mb-0">
            ...
            <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              ...
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50  ">
                <span className="text-3xl text-white">Pricing UI</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col gap-y-10  ">
            <div className="mt-96 group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              ...
              {/* pretitle */}
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50  ">
                <span className="text-3xl text-white">Web3.0</span>
              </div>
            </div>
            <div className=" mt-16 group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              ...
              {/* pretitle */}
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50  ">
                <span className="text-3xl text-white">Panaverse</span>
              </div>
            </div>
            <div className=" mt-16 group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              {/*overlay */}
              ...
              {/* pretitle */}
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50  ">
                <span className="text-3xl text-white">Metaversus</span>
              </div>
            </div>
          </div>
        </div>
